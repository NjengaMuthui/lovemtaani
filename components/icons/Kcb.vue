<template>
  <svg
    ...
    y="0px"
    viewBox="0 0 205 68"
    style="enable-background: new 0 0 205 68"
    xml:space="preserve"
  >
    <polygon fill="#80bc00" points="0,0 205,0 205,68 0,68 "></polygon>
    <g>
      <path
        fill="#003b4d"
        d="M95.1,14.1c-0.4-2.7-2.1-1.9-1.8-2.8c0.1-0.3-0.2-1.5-2-1.5H57.2v19.8c0.7,0.1,1.3,0,1.9-0.4
      ...
      <polygon
        fill="#ffffff"
        points="112.2,44.8 107.1,44.8 99.8,34.3 99.8,44.8 95.5,44.8 95.5,22.4 99.8,22.4 99.8,31.9 107.6,22.4 
		111.6,22.4 103.6,32.3 	"
      ></polygon>
      <path
        fill="#ffffff"
        d="M123.6,45.2c-7.1,0-11-4.1-11-11.6c0-3.6,0.8-6.5,2.5-8.5c1.8-2,4.4-3.1,7.1-3c1.9,0.1,3.8,0.4,5.7,0.7
      ...
      <path
        fill="#ffffff"
        d="M140.6,44.8h-7.8V22.4h7.2c1.6-0.1,3.3,0.2,4.7,1c1.5,1,2.3,2.7,2.1,4.4c0.1,1.4-0.4,2.7-1.4,3.8l-0.6,0.6
